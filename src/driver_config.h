...
/// Firmware version: QN_9020_B2, QN_9020_B4
#define QN_9020_B2
#define QN_DEBUG_UART                                   QN_UART0
/// Memory retention
#define CFG_MEM_RETENTION                               (MEM_BLOCK1 | MEM_BLOCK2)
...
#define CONFIG_ENABLE_DRIVER_RTC                        TRUE        /*!< Enable/Disable RTC Driver */
